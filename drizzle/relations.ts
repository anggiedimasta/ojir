...
import { ojirUser, ojirTransaction, ojirCalendarEvent, ojirSession, ojirAccount } from "./schema";

export const ojirTransactionRelations = relations(ojirTransaction, ({one}) => ({
	user: one(ojirUser, {
...
export const ojirCalendarEventRelations = relations(ojirCalendarEvent, ({one}) => ({
