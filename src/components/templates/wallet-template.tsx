      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        {summary && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <SummaryCard
              title="Net Income"
              value={formatCurrency((summary.totalIncome - summary.totalExpense).toString())}
              icon={Wallet}
              gradient="bg-gradient-to-br from-blue-50 to-indigo-50"
              borderColor="border-blue-200"
              iconBgColor={summary.totalIncome - summary.totalExpense >= 0 ? "bg-green-100" : "bg-red-100"}
              iconColor={summary.totalIncome - summary.totalExpense >= 0 ? "text-green-600" : "text-red-600"}
              valueColor={summary.totalIncome - summary.totalExpense >= 0 ? "text-green-800" : "text-red-800"}
