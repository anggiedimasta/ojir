...
export const BankMandiriBadge = () => (
  <div className="inline-flex items-center gap-2 rounded-md border border-blue-200 bg-blue-50 px-2 py-1">
    <div className="h-4 w-4 overflow-hidden rounded-sm bg-white">
      <Image
        ...
        onError={(e) => {
          ...
          if (target.parentElement) {
            target.parentElement.innerHTML =
              '<svg class="w-full h-full text-blue-600" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2L3 7v11h14V7l-7-5zM8 16H6v-4h2v4zm4 0h-2v-4h2v4zm4 0h-2v-4h2v4z"/></svg>';
          }
        }}
      />
    </div>
    <span className="font-medium text-blue-700 text-xs">Bank Mandiri</span>
  </div>
);
