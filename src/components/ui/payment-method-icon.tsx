...
import { CreditCard, QrCode, Banknote, Zap } from 'lucide-react';
...
export const PaymentMethodIcon: React.FC<PaymentMethodIconProps> = ({ 
  ...
  const getPaymentMethodIcon = (method: string) => {
    ...
    // Virtual Account
    if (normalizedMethod.includes('virtual') || normalizedMethod.includes('account')) {
      return <CreditCard className={className} />;
    }

    // BI-FAST
    if (normalizedMethod.includes('bi-fast') || normalizedMethod.includes('bifast')) {
