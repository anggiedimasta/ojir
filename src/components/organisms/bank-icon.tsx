...
export const BankIcon: React.FC<BankIconProps> = ({ bankName, className = "w-4 h-4" }) => {
  const getBankIcon = (bank: string) => {
    ...
    return (
      <div className={`${className} rounded-sm overflow-hidden bg-white flex items-center justify-center`}>
...
export const BankMandiriBadge = () => (
  <Badge variant="outline" size="sm" className="bg-blue-50 border-blue-200 text-blue-700">
    Bank Mandiri
  </Badge>
); 